...
{
    [Table("PEDIDOVENDAITEMAPURACAOIMPOSTO", Schema = "DBO")]
    public class PedidoVendaItemApuracaoImposto
    {
        [Key]
        [DisplayName("IdPedidoVendaItemApuracaoImposto")]
        [Column("IDPEDIDOVENDAITEMAPURACAOIMPOSTO")]
        public int IdPedidoVendaItemApuracaoImposto { get; set; }
