...
{
    [Table("PEDIDOVENDACONTABILIDADE", Schema = "DBO")]
    public class PedidoVendaContabilidade
    {
        [Key]
        [DisplayName("IdPedidoVendaContabilidade")]
        [Column("IDPEDIDOVENDACONTABILIDADE")]
        public int IdPedidoVendaContabilidade { get; set; }
