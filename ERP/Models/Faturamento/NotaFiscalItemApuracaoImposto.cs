...
{
    [Table("NOTAFISCALITEMAPURACAOIMPOSTO", Schema = "DBO")]
    public class NotaFiscalItemApuracaoImposto
    {
        [Key]
        [DisplayName("IdNotaFiscalItemApuracaoImposto")]
        [Column("IDNOTAFISCALITEMAPURACAOIMPOSTO")]
        public int IdNotaFiscalItemApuracaoImposto { get; set; }
