...
namespace ERP
{
    public partial class frmPedidoCompraApuracaoImposto : RibbonForm
    {
        public PedidoCompraItemApuracaoImpostoDAL dal;
        PedidoCompraItemApuracaoImposto ai = new PedidoCompraItemApuracaoImposto();
        int IdItem;
        public frmPedidoCompraApuracaoImposto(int Id)
        {
        ...
        private void CarregaDados()
        {
            ...
            chkManterValores.Checked = Convert.ToBoolean(ai.ManterDadosAjustados);
        ...
        private void btnGrava_Click(object sender, EventArgs e)
        {
            if (Util.Validacao.ValidaCampos(this))
            {
                try
                {
                    ...
                    ai.ManterDadosAjustados = chkManterValores.Checked;
                    if (ai.IdPedidoCompraItemApuracaoImposto == 0)
                    {
                        dal.Insert(ai);
                    }
                    else
                    ...
                    BLL.BLImpostoEncargosCompras blimposto = new BLL.BLImpostoEncargosCompras();
                    blimposto.dal = dal;
                    blimposto.GeraImpostos((int)ai.IdPedidoCompraItem);
