...
namespace ERP
{
    public partial class frmPedidoCompraContabilidade : RibbonForm
    {
        public PedidoCompraContabilidadeDAL dal;
        PedidoCompraContabilidade ai = new PedidoCompraContabilidade();
        int IdItem;
        public frmPedidoCompraContabilidade(int Id)
        { 
            IdItem = Id;
            InitializeComponent(); 
        } 
        ...
        private void CarregaDados()
        {
            ...
            txtFornecedor.Text = new FornecedorDAL().FRepository.GetByID(ai.IdFornecedor).RazaoSocial;
        ...
        private void btnGrava_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(Ajustado)
                {
                    ...
                    PedidoCompraContabilidade c = new PedidoCompraContabilidade();
                    ...
                    c.Origem = ai.Origem;
                    c.IdPedidoCompra = ai.IdPedidoCompra;
                    c.IdPedidoCompraItem = ai.IdPedidoCompraItem;
