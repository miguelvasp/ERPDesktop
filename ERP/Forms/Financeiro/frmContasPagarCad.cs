...
namespace ERP
{
    public partial class frmContasPagarCad : RibbonForm
    {
        public ContasPagarDAL dal = new ContasPagarDAL();
        ContasPagarAbertoDAL aDal = new ContasPagarAbertoDAL();
        ContasPagar c = new ContasPagar();

        public frmContasPagarCad(ContasPagar pC)
        {
            c = pC; 
            InitializeComponent();
        ...
        private void CarregaCombos()
        {
            ...
            tptrans.Add(new ComboItem() { iValue = 1, Text = "Pedido de Compra"});
            tptrans.Add(new ComboItem() { iValue = 2, Text = "Carta de Cobrança"});
            tptrans.Add(new ComboItem() { iValue = 3, Text = "Diário"});
            tptrans.Add(new ComboItem() { iValue = 4, Text = "Cancelamento"});
            tptrans.Add(new ComboItem() { iValue = 5, Text = "Liquidação"});
            tptrans.Add(new ComboItem() { iValue = 6, Text = "Pagamento"});
            tptrans.Add(new ComboItem() { iValue = 7, Text = "Desconto a vista"});
            tptrans.Add(new ComboItem() { iValue = 8, Text = "Totalizado"});
            tptrans.Add(new ComboItem() { iValue = 9, Text = "Comissão" });
        ...
        private void CarregaDados()
        {
            ...
            cboFornecedor.SelectedValue = c.IdFornecedor == null ? 0 : c.IdFornecedor;
            ...
            cboPerfilFornecedor.SelectedValue = c.IdPerfilFornecedor == null ? 0 : c.IdPerfilFornecedor;
            ...
            txtIdContasPagar.Text = c.IdContasPagar == null ? "" : c.IdContasPagar.ToString();
            txtNFSE.Text = c.NFSE == null ? "" : c.NFSE.ToString();
            txtOBS.Text = c.Observacao == null ? "" : c.Observacao.ToString();
            txtPedidoCompras.Text = c.PedidoCompras; 
            ...
            txtValorTotalServicos.Text = c.ValorTotalServico == null ? "" : c.ValorTotalServico.ToString();
        ...
        private void btnGrava_Click(object sender, EventArgs e)
        {
            if (Util.Validacao.ValidaCampos(this))
            {
                try
                {
                    ...
                    c.IdMoeda = null;
                    c.IdPerfilFornecedor = null;
                    c.Status = null;
                    c.TipoTransacao = null; 
                    c.PedidoCompras = null;
                    c.Saldo = null;
                    c.ValorLiquido = null;
                    c.ValorPago = null;
                    c.ValorTotalServico = null;
                    c.ValorTitulo = null;
                    c.Vencimento = null;
                    ...
                    if (!String.IsNullOrEmpty(cboPerfilFornecedor.Text)) c.IdPerfilFornecedor = Convert.ToInt32(cboPerfilFornecedor.SelectedValue);
                    ...
                    if (!String.IsNullOrEmpty(txtNFSE.Text)) c.NFSE = txtNFSE.Text;
                    if (!String.IsNullOrEmpty(txtOBS.Text)) c.Observacao = txtOBS.Text;
                    if (!String.IsNullOrEmpty(txtPedidoCompras.Text)) c.PedidoCompras = txtPedidoCompras.Text;
                    ...
                    if (!String.IsNullOrEmpty(txtValorTotalServicos.Text)) c.ValorTotalServico = Convert.ToDecimal(txtValorTotalServicos.Text);
                    ...
                    var lista = dal.GetContasEmAberto(c.IdContasPagar);
            ...
            if(dataGridView1.Rows.Count > 0)
             {
                ...
                ContasPagarAberto ca = dal.EmAbertoDal.GetByID(id);
                using (frmContasPagarAberto frmCadAberto = new frmContasPagarAberto(ca))
                {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            ContasPagarAberto ca = new ContasPagarAberto();
            using (frmContasPagarAberto frmCadAberto = new frmContasPagarAberto(ca))
            {
                frmCadAberto.cp = c; 
                frmCadAberto.pagDal = dal;
