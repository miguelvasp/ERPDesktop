...
namespace ERP
{
    public partial class frmRecebimentoLote : Form
    {
        RecebimentoLoteDAL dal = new RecebimentoLoteDAL();

        public frmRecebimentoLote()
        {
            InitializeComponent(); 
        }
        ...
        {
            frmRecebimentoLotePreparacao preparacao = new frmRecebimentoLotePreparacao();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            if(dgv.Rows.Count > 0)
            {
                ...
                using (frmRecebimentoLoteCad frmcad = new frmRecebimentoLoteCad(id))
                {
                    frmcad.ShowDialog();
                }
                CarregaGrid();
