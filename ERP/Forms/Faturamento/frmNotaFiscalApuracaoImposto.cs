...
namespace ERP
{
    public partial class frmNotaFiscalApuracaoImposto : RibbonForm
    {
        public NotaFiscalItemApuracaoImpostoDAL dal;
        NotaFiscalItemApuracaoImposto ai = new NotaFiscalItemApuracaoImposto();
        int IdItem;
        public frmNotaFiscalApuracaoImposto(int Id)
        { 
            IdItem = Id;
            InitializeComponent(); 
        }
        ...
        private void btnGrava_Click(object sender, EventArgs e)
        {
            if (Util.Validacao.ValidaCampos(this))
            {
                try
                {
                    ...
                    if (ai.IdNotaFiscalItemApuracaoImposto == 0)
                    {
                        dal.Insert(ai);
                    }
                    else
