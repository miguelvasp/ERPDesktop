...
namespace ERP
{
    public partial class frmGrupoImpostoItemCad : RibbonForm
    {
        public GrupoImpostoItemDAL dal = new GrupoImpostoItemDAL();
        ConfGrupoImpostoItemDAL cidal = new ConfGrupoImpostoItemDAL();
        GrupoImpostoItem gir = new GrupoImpostoItem();
        List<ConfGrupoImpostoItemModelView> Configuracoes = new List<ConfGrupoImpostoItemModelView>();

        public frmGrupoImpostoItemCad(GrupoImpostoItem pGIR)
        {
            gir = pGIR;
            InitializeComponent();
        }
        ...
        private void CarregaDados()
        {
            ...
            lbCodigo.Text = gir.IdGrupoImpostoItem.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ConfGrupoImpostoItem c = new ConfGrupoImpostoItem();
                c.IdGrupoImpostoItem = gir.IdGrupoImpostoItem;
                frmConfGrupoImpostoItemCad f = new frmConfGrupoImpostoItemCad(c);
                f.dal = cidal;
                f.ShowDialog();
                CarregaGrid();
            }
        ...
        private void CarregaGrid()
        {
            ...
            Configuracoes = cidal.GetByGrupoImpostoItem(gir.IdGrupoImpostoItem);
        ...
        private void dgConfiguracoes_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ConfGrupoImpostoItem c = cidal.GetByID(id);
            frmConfGrupoImpostoItemCad f = new frmConfGrupoImpostoItemCad(c);
            f.dal = cidal;
            f.ShowDialog();
            CarregaGrid();
