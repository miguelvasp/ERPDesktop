sp_rename Lote, RecebimentoItemLote
GO
...
IF EXISTS(SELECT * FROM dbo.RecebimentoItemLote)
	 EXEC('INSERT INTO dbo.Tmp_RecebimentoItemLote (IdLote, Numero, DataVencimento, DataFabricacao, DataAvisoPrateleira, DataValidade, DataUltimoTeste, LoteFornecedor, NumeroFornecedor, DataVencimentoFornecedor, DataFabricacaoFornecedor, DataAvisoPrateleiraFornecedor)
		SELECT IdLote, Numero, DataVencimento, DataFabricacao, DataAvisoPrateleira, DataValidade, DataUltimoTeste, LoteFornecedor, NumeroFornecedor, DataVencimentoFornecedor, DataFabricacaoFornecedor, DataAvisoPrateleiraFornecedor FROM dbo.RecebimentoItemLote WITH (HOLDLOCK TABLOCKX)')
GO
...
ALTER TABLE dbo.OrdemProducao
	DROP CONSTRAINT FK_OrdemProducao_Lote
GO
ALTER TABLE dbo.OrdemProducaoLinha
	DROP CONSTRAINT FK_OrdemProducaoLinha_Lote
GO
