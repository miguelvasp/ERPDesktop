USE [Acrilplus_Producao]
GO

/****** Object:  View [dbo].[vwPedidoVendasRel]    Script Date: 08/16/2016 10:26:18 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	(P.EstqouePesoBruto * I.Quantidade) as PesoUnitario,
	VC.Descricao as Cor,
	I.DescontoVarejista,
	I.QuantidadePorFaturar, 
